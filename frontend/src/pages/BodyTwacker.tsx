...
const measurementSchema = z.object({
  ...
  measurement_type: z
    ...
    .refine((val) => val !== "0", "Select a valid type"),
});
...
export const BodyTwacker = () => {
  ...
  const {
    measurements,
    measurements__isLoading,
    addMeasurement,
    editMeasurement,
  } = useMeasurements();
  const { measurementTypes, measurementTypes__isLoading } =
    useMeasurementTypes();
  ...
  const currentLogs = measurements.slice(
